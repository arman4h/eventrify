<aside class="hidden md:flex md:flex-shrink-0" data-sidebar>
    <div class="flex flex-col w-64 bg-sidebar">
        ...
        <div class="flex items-center h-16 px-6 bg-sidebar-light">
            ...
            <svg
                class="w-8 h-8 text-primary-400 mr-3"
                fill="currentColor"
                viewBox="0 0 24 24"
            >
        ...
        <nav class="flex-1 px-4 py-6 space-y-1">
            ...
            <a
                href="<?= url('/admin') ?>"
                class="flex items-center px-3 py-2 text-sm font-medium text-gray-300 rounded-lg hover:bg-sidebar-light hover:text-white transition-colors <?= ($activePage ?? '') === 'dashboard' ? 'bg-sidebar-light text-white' : '' ?>"
            >
            ...
            <a
                ...
                class="flex items-center px-3 py-2 text-sm font-medium text-gray-300 rounded-lg hover:bg-sidebar-light hover:text-white transition-colors <?= ($activePage ?? '') === 'applications' ? 'bg-sidebar-light text-white' : '' ?>"
            >
            ...
            <a
                ...
                class="flex items-center px-3 py-2 text-sm font-medium text-gray-300 rounded-lg hover:bg-sidebar-light hover:text-white transition-colors <?= ($activePage ?? '') === 'reports' ? 'bg-sidebar-light text-white' : '' ?>"
            >
        ...
        <div class="p-4 border-t border-gray-800">
            ...
            <a
                href="<?= url('/logout') ?>"
                class="flex items-center px-3 py-2 text-sm font-medium text-gray-400 rounded-lg hover:bg-sidebar-light hover:text-white transition-colors"
            >
