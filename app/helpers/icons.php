...
function icon(string $name, string $class = 'w-5 h-5', int $stroke = 2): string
{
    $paths = [
        'dashboard'      => '<path stroke-linecap="round" stroke-linejoin="round" d="M3 12l9-9 9 9M5 10v10a1 1 0 001 1h3a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1h3a1 1 0 001-1V10"/>',
        ...
        'users'          => '<path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-2.209 2.239-4 5-4s5 1.791 5 4m-5-10a3 3 0 100-6 3 3 0 000 6z"/>',
        ...
        'sign-out'       => '<path stroke-linecap="round" stroke-linejoin="round" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"/>',
        ...
        'qr'             => '<path stroke-linecap="round" stroke-linejoin="round" d="M3 3h7v7H3V3zm.5 14v-2h2m7-12h2v2m-9.5 0H5v2m0 8.5h2v2H5v-2zm7 2h-2v-2h2v2zm2-7h7v7h-7v-2h5v-3h-5v-2zm0 5h2v2h-2v-2z"/>',
        'arrow-right'    => '<path stroke-linecap="round" stroke-linejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3"/>',
        'arrow-left'     => '<path stroke-linecap="round" stroke-linejoin="round" d="M7 16l-4-4m0 0l4-4m-4 4h18"/>',
        ...
        'filter'         => '<path stroke-linecap="round" stroke-linejoin="round" d="M3 4h18l-8 9v5l-4 2v-7L3 4z"/>',
        'download'       => '<path stroke-linecap="round" stroke-linejoin="round" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>',
        ...
        'eye-off'        => '<path stroke-linecap="round" stroke-linejoin="round" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7a9.966 9.966 0 012.284-4.171M6.1 7.1C8 5.784 9.992 5 12 5c4.478 0 8.268 2.943 9.542 7a9.956 9.956 0 01-2.284 4.171M9.88 9.88a3 3 0 104.24 4.24M3 3l18 18"/>',
        ...
        'star'           => '<path stroke-linecap="round" stroke-linejoin="round" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.196-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"/>',
        'more-h'         => '<path stroke-linecap="round" stroke-linejoin="round" d="M5 12h.01M12 12h.01M19 12h.01M6 12a1 1 0 11-2 0 1 1 0 012 0zm7 0a1 1 0 11-2 0 1 1 0 012 0zm7 0a1 1 0 11-2 0 1 1 0 012 0z"/>',
        ...
        'grad'           => '<path stroke-linecap="round" stroke-linejoin="round" d="M12 14l9-5-9-5-9 5 9 5z"/><path stroke-linecap="round" stroke-linejoin="round" d="M12 14v5m0-5l-6.162-3.425M12 19l-6.162-3.425M12 19l6.162-3.425"/>',
        ...
        'upload-cloud'   => '<path stroke-linecap="round" stroke-linejoin="round" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6h.1a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"/>',
        'copy-check'     => '<path stroke-linecap="round" stroke-linejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"/>',
    ...
    return '<svg class="' . e($class) . '" fill="none" stroke="currentColor" stroke-width="' . $stroke . '" viewBox="0 0 24 24" aria-hidden="true">' . $path . '</svg>';
}